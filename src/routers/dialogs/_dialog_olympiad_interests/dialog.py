...
from routers.states import OlympiadInterestSG
...
olympiad_interest_window = Window(
    ...
    SwitchTo(Const("Начать"), id="start_asking_interests", state=OlympiadInterestSG.ask_user_for_class),
    NAVIGATION_BAR,
...
ask_for_class_window = Window(
    ...
    SwitchTo(Const("Далее  ➡️"), id="ask_for_subjects", state=OlympiadInterestSG.ask_user_for_subjects),
    NAVIGATION_BAR,
    state=OlympiadInterestSG.ask_user_for_class,
    getter=get_options
)
...
ask_for_subjects_window = Window(
    ...
    SwitchTo(Const("Далее  ➡️"), id="ask_for_levels", state=OlympiadInterestSG.ask_user_for_olympiad_level),
    NAVIGATION_BAR,
    state=OlympiadInterestSG.ask_user_for_subjects,
    getter=get_options,
    parse_mode="HTML"
)
...
ask_for_levels_window = Window(
    ...
    NAVIGATION_BAR,
    state=OlympiadInterestSG.ask_user_for_olympiad_level,
    getter=get_options,
    parse_mode="HTML",
)
