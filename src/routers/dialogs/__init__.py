...
from ._dialog_search_olympiad import dialog as dialog_search_olympiad
from ._dialog_admin import dialog as dialog_admin

dialogs = [dialog_hello, dialog_help, dialog_olympiad_interests, dialog_search_olympiad, dialog_admin]
